...
export default function DiscussionRoomCard({ discussionRoom }) {
  ...
  return (
    <div
      id={`${_id}`}
      className='bg-white shadow-lg flex flex-col lg:flex-row justify-between items-center gap-3 w-full border-2 rounded-lg p-3'>
      ...
      <div className='flex-grow flex flex-col justify-center items-center lg:block'>
        ...
        <div className='flex items-center mb-1'>
          ...
          <span className='font-medium'>
            Subject :
            <span className='text-primary-1'>{` ${jenisRunding}`}</span>
          </span>
        </div>
      </div>
